// Path: src/pages/QuafiHome/QuafiHome.tsx
// QUAFI Home Page - Stone Marble Neumorphism with Natural Color Palette

import { useNavigate } from "react-router-dom";
import { QuafiWordmarkText } from "@/components/atoms/QuafiWordmark";
import { QuafiEmblem } from "@/components/atoms/QuafiEmblem";
import styles from "./QuafiHome.module.css";
  ...
  return (
    <div className={styles.home}>
      ...
      <section className={`${styles.section} ${styles.hero}`}>
        ...
        <QuafiWordmarkText variant="carved" size={120} />
      ...
      <section className={styles.section}>
        ...
        <div className={styles.synthesisCard}>
          <div className={styles.synthesisFormula}>
            <span className={styles.synthesisHighlight}>FIN</span>ance + e
            <span className={styles.synthesisHighlight}>NG</span>ine
          </div>
          <div className={styles.synthesisResult}>The financial engine.</div>
        </div>

        {/* Vertical Inset Line */}
        <div className={styles.verticalInsetLine} />

        {/* QUAFI Wordmark - Carved with brand color */}
        <QuafiWordmarkText
          variant="carved"
          size={120}
