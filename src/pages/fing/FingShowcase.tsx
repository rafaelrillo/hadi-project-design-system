// Path: src/pages/fing/FingShowcase.tsx
// FING Design System - Glass-Neumorphism Showcase
...
import {
  ...
  RiskProfileSelector,
  AllocationSummary,
} from '../../components/molecules/fing';
import { LineChart } from '../../components/charts/echarts/LineChart';
import type { MarketState, RiskLevel } from '../../components/organisms/fing';
import type { RiskProfile } from '../../components/molecules/fing';
  ...
  return (
    <div style={{ background: MARBLE.base, minHeight: '100%', padding: '24px' }}>
      <header style={pageHeaderStyles}>
        <h1 style={titleStyles}>&gt; FING_Components_</h1>
          ...
          <div style={{ display: 'flex', gap: '24px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <div style={{ textAlign: 'center' }}>
              <div style={lightEngineBoxBase}>
                <span style={{ fontFamily: 'var(--fing-font-display)', fontSize: '14px', fontWeight: 600, color: 'var(--fing-text-primary)' }}>Layered</span>
                <span style={{ fontFamily: 'var(--fing-font-mono)', fontSize: '10px', color: '#636E72' }}>5 capas</span>
              </div>
              <p style={{ marginTop: '8px', fontSize: '11px', color: '#636E72', fontFamily: 'var(--fing-font-mono)' }}>Cards, Panels</p>
            </div>

            <div style={{ textAlign: 'center' }}>
              <div style={{ ...lightEngineBoxBase, boxShadow: getNeuInsetShadow(4, 12) }}>
                <span style={{ fontFamily: 'var(--fing-font-display)', fontSize: '14px', fontWeight: 600, color: 'var(--fing-text-primary)' }}>Inset</span>
                <span style={{ fontFamily: 'var(--fing-font-mono)', fontSize: '10px', color: '#636E72' }}>recessed</span>
              </div>
              <p style={{ marginTop: '8px', fontSize: '11px', color: '#636E72', fontFamily: 'var(--fing-font-mono)' }}>Inputs, Wells</p>
            </div>

            <div style={{ textAlign: 'center' }}>
              <div style={{ ...lightEngineBoxBase, background: 'rgba(91, 163, 165, 0.1)', border: '1px solid rgba(91, 163, 165, 0.2)' }}>
                <span style={{ fontFamily: 'var(--fing-font-display)', fontSize: '14px', fontWeight: 600, color: 'var(--fing-text-primary)' }}>Glass</span>
                <span style={{ fontFamily: 'var(--fing-font-mono)', fontSize: '10px', color: '#636E72' }}>+ reflection</span>
              </div>
              <p style={{ marginTop: '8px', fontSize: '11px', color: '#636E72', fontFamily: 'var(--fing-font-mono)' }}>Overlays, Modals</p>
            </div>
          </div>
        </div>
      </ShowcaseSection>
              ...
              <div key={depth} style={{ padding: '8px', borderRadius: '12px', boxShadow: getNeuPanelShadow(depth * 2, depth * 6), background: MARBLE.base }}>
                <DepthLayer depth={depth}>
                  <div style={{ padding: '24px', textAlign: 'center' }}>
                    <span style={{ fontFamily: 'var(--fing-font-mono)', fontSize: '12px', color: '#636E72' }}>Depth {depth}</span>
                  </div>
                </DepthLayer>
              </div>
            ))}
        ...
        <div style={contentContainerStyles}>
          <div style={{ width: '100%', height: '200px', borderRadius: '12px', overflow: 'hidden', boxShadow: getNeuInsetShadow(5, 15) }}>
            <AtmosphericBackground variant="intense" contained>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%', color: '#636E72', fontSize: '14px', fontFamily: 'var(--fing-font-mono)' }}>
      ...
      <ShowcaseSection title="Especificaciones Técnicas">
        <div style={insetContainerStyles}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '32px', fontSize: '13px', color: '#636E72', lineHeight: '2', fontFamily: 'var(--fing-font-mono)' }}>
            <div>
              <p style={{ color: 'var(--fing-accent-primary)', fontWeight: 600 }}>Level 1: Core</p>
            ...
            <div>
              <p style={{ color: 'var(--fing-accent-primary)', fontWeight: 600 }}>Level 2: Context</p>
              <p>• FactorWeight</p>
              <p>• TrendIndicator</p>
            ...
            <div>
              <p style={{ color: 'var(--fing-accent-primary)', fontWeight: 600 }}>Level 3: Action</p>
            ...
            <div>
              <p style={{ color: 'var(--fing-accent-primary)', fontWeight: 600 }}>Atmospheric</p>
              <p>• AtmosphericBackground</p>
              <p>• DepthLayer</p>
              <p>• DataReveal</p>
            </div>
            <div>
              <p style={{ color: 'var(--fing-accent-primary)', fontWeight: 600 }}>Charts</p>
            ...
            <div>
              <p style={{ color: 'var(--fing-accent-primary)', fontWeight: 600 }}>Animations</p>
              <p>• FadeIn</p>
              <p>• StaggerList</p>
              <p>• MotionCard</p>
              <p>• ScrollReveal</p>
