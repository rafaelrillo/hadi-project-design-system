    ...
    >
      ...
      >
        <ComponentPreview>
          ...
          >
            <Paragraph>
              Este es un párrafo de ejemplo. El componente Paragraph usa 14px
              Regular con line-height 1.2. Ideal para contenido de texto general
              en la aplicación.
            </Paragraph>
            <Paragraph>
          ...
          >
            ...
            >
              ...
              <Paragraph style={{ marginTop: "12px" }}>
                Este es un sistema de diseño completo que incluye componentes
            ...
            <div>
              ...
              <Paragraph style={{ marginTop: "12px" }}>
                Los componentes están organizados siguiendo la metodología
                Atomic Design.
              </Paragraph>
            </div>
            ...
            <div>
              ...
              <Paragraph style={{ marginTop: "12px" }}>
                Los átomos son los elementos más básicos, mientras que las
                moléculas combinan varios átomos.
              </Paragraph>
            </div>
            ...
            <div>
              ...
              <Paragraph style={{ marginTop: "12px" }}>
                Todos los componentes siguen las guías de estilo definidas en el
                design system.
              </Paragraph>
            </div>
          </div>
            ...
            >
              ...
              >
                <div>
                  ...
                  <Heading3
                    effect="carved-whisper"
                    style={{ marginTop: "4px" }}
                  >
                    Ultra-sutil para mobile y vistas compactas
                  </Heading3>
                </div>
                <div>
                  <Label effect="carved-muted">
                    standard — var(--lp-primary)
                  </Label>
                  <Heading3 effect="carved" style={{ marginTop: "4px" }}>
                    Intensidad base para texto general
                  </Heading3>
                </div>
                <div>
                  <Label effect="carved-muted">
                    strong — var(--lp-primary-strong)
                  </Label>
                  <Heading3 effect="carved-strong" style={{ marginTop: "4px" }}>
                    Enfasis fuerte para valores y titulos hero
                  </Heading3>
                </div>
              </div>
            </div>
      ...
      >
        <ComponentPreview>
          <div style={{ width: "100%" }}>
            ...
            >
              <Label effect="carved-muted">
                RAISED Container — Carved Semántico
              </Label>
              <div
                style={{
                  display: "grid",
      ...
      >
          ...
          <div style={{ width: "100%" }}>
            ...
            >
              <Label effect="embossed">
                INSET Container — Escala de Intensidad
              </Label>
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                <div>
                  ...
                  <Heading3
                    effect="embossed-subtle"
                    style={{ marginTop: "4px" }}
                  >
                    Sutil para texto secundario
                  </Heading3>
                </div>
                <div>
                  <Label effect="embossed">standard — var(--lp-embossed)</Label>
                  <Heading3 effect="embossed" style={{ marginTop: "4px" }}>
                    Base para texto general en inset
                  </Heading3>
                </div>
                <div>
                  <Label effect="embossed">
                    strong — var(--lp-embossed-strong)
                  </Label>
                  <Heading3
                    effect="embossed-strong"
                    style={{ marginTop: "4px" }}
                  >
                    Fuerte para titulos principales
                  </Heading3>
                </div>
              </div>
            </div>
        ...
        <ComponentPreview>
          <div style={{ width: "100%" }}>
            ...
            >
              <Label effect="embossed">
                INSET Container — Colores Semánticos
              </Label>
              <div
                style={{
                  display: "grid",
          ...
          <div style={{ width: "100%" }}>
            ...
            >
              ...
              <div style={{ marginTop: "16px" }}>
                ...
                <Paragraph
                  effect="carved-muted"
                  style={{ color: "var(--foreground-muted)", marginTop: "8px" }}
                >
        ...
        <ComponentPreview>
          <div style={{ width: "100%", display: "flex", gap: "16px" }}>
            ...
            >
              ...
              >
                <Heading3 effect="embossed-subtle">
                  synthesisFormula → --lp-embossed-subtle
                </Heading3>
                <Heading3
                  effect="embossed-petrol"
                  style={{ color: "var(--quafi-accent)" }}
          ...
          <div style={{ width: "100%", display: "flex", gap: "16px" }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                ...
                <Label effect="carved-muted" style={{ marginTop: "4px" }}>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Label effect="embossed" style={{ textAlign: "right" }}>
                    Price
                  </Label>
                  <Label effect="embossed" style={{ textAlign: "right" }}>
                    Change
                ...
                >
                  ...
                  <Paragraph effect="carved" style={{ textAlign: "right" }}>
                    $189.84
                  </Paragraph>
                  <Paragraph
                    effect="carved-positive-md"
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Label effect="carved-muted" style={{ marginTop: "4px" }}>
                    raisedButton → carved-accent-strong
                  </Label>
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  <Label effect="carved-muted" style={{ marginTop: "2px" }}>
                    pillFrameButtonSm → carved-petrol-md
                  </Label>
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  <Label effect="carved-muted" style={{ marginTop: "2px" }}>
                    dataTableTitleSell → carved-negative-md
                  </Label>
                </div>
              </div>
            </div>
          ...
          <div style={{ width: "100%", maxWidth: "375px", margin: "0 auto" }}>
            ...
            >
              ...
              >
                ...
                <Heading2 effect="carved-strong" style={{ marginTop: "4px" }}>
                  $124,500
                </Heading2>
                <Paragraph
                  effect="carved-positive-md"
        ...
        >
          <p style={{ marginBottom: "8px" }}>
            <strong style={{ color: "var(--primary)" }}>
              CARVED (texto en containers RAISED):
            </strong>
          </p>
          ...
          <p style={{ marginTop: "16px", marginBottom: "8px" }}>
            <strong style={{ color: "var(--primary)" }}>
              EMBOSSED (texto en containers INSET):
            </strong>
          </p>
      ...
      <ShowcaseSection title="Especificaciones Tecnicas">
        ...
        >
          ...
          <p>
            <strong style={{ color: "var(--primary)" }}>Color base:</strong>{" "}
            var(--foreground)
          </p>
