...
// SENTINEL Design System - Glass-Neumorphism Level 4 Depth Components
...
const modelMetadata: ModelMetadata = {
  name: 'SENTINEL Alpha Model', version: { version: '2.4.1', releaseDate: '2024-12-20', changes: ['Improved sentiment analysis accuracy', 'Added options flow signals', 'Enhanced regime detection'] },
  ...
  return (
    <div style={{ background: MARBLE.base, minHeight: '100%', padding: '24px' }}>
      ...
      <ShowcaseSection title="BacktestResults" description="Comprehensive backtesting results with trade history">
        <div style={contentContainerStyles}>
          <BacktestResults summary={backtestSummary} statistics={backtestStatistics} trades={backtestTrades} strategyName="SENTINEL Momentum Strategy" benchmarkName="S&P 500" benchmarkReturn={32.5} showTrades maxTradesVisible={5} onTradeClick={(trade) => console.log('Trade clicked:', trade)} />
        </div>
      </ShowcaseSection>
      ...
      <ShowcaseSection title="Especificaciones Técnicas">
        <div style={insetContainerStyles}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '32px', fontSize: '13px', color: '#636E72', lineHeight: '2', fontFamily: 'var(--sentinel-font-mono)' }}>
            <div>
              <p style={{ color: 'var(--sentinel-accent-primary)', fontWeight: 600 }}>Historical Analysis</p>
            ...
            <div>
              <p style={{ color: 'var(--sentinel-accent-primary)', fontWeight: 600 }}>Model Transparency</p>
              <p>• ModelInsights - Technical model details and methodology</p>
            </div>
            <div>
              <p style={{ color: 'var(--sentinel-accent-primary)', fontWeight: 600 }}>Correlation & Performance</p>
              <p>• CorrelationMatrix - Asset correlation heatmap</p>
              <p>• PerformanceChart - Historical performance visualization</p>
            </div>
            <div>
              <p style={{ color: 'var(--sentinel-accent-primary)', fontWeight: 600 }}>Backtesting</p>
