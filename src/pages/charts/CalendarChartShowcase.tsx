...
// QUAFI Design System - Glass-Neumorphism Calendar Chart
  ...
  return (
    <div style={{ background: 'var(--marble-base)', minHeight: '100%', padding: '24px' }}>
      <header style={{ ...showcase.header.container, boxShadow: 'var(--raised-3)' }}>
        <h1 style={showcase.header.title}>&gt; CalendarChart_</h1>
        <p style={showcase.header.description}>// Heatmap calendario para visualizar datos diarios</p>
      </header>
