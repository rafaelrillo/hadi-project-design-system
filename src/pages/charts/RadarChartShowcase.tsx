...
// QUAFI Design System - Glass-Neumorphism Radar Chart
  ...
  return (
    <div style={{ background: 'var(--marble-base)', minHeight: '100%', padding: '24px' }}>
      <header style={showcase.header.container}>
        <h1 style={showcase.header.title}>&gt; RadarChart_</h1>
        <p style={showcase.header.description}>// Comparacion multidimensional para perfiles de riesgo</p>
      </header>
