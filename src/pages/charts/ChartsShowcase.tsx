...
// QUAFI Design System - Glass-Neumorphism Charts Hub
  ...
  return (
    <div style={{ background: MARBLE.base, minHeight: '100%', padding: '32px' }}>
      ...
      <header style={pageHeaderStyles}>
        ...
        <p style={descStyles}>
          Comprehensive chart library powered by ECharts with full QUAFI theme integration.
      ...
      <ShowcaseSection title="ECharts Components Overview">
        <div style={{
          ...
          <p>✓ <strong style={{ color: 'var(--quafi-accent-primary)' }}>Financial:</strong> CandlestickChart, LineChart, BarChart</p>
          <p>✓ <strong style={{ color: 'var(--quafi-accent-primary)' }}>Circular:</strong> PieChart, RadarChart, GaugeChart, SunburstChart</p>
          <p>✓ <strong style={{ color: 'var(--quafi-accent-primary)' }}>Comparison:</strong> TreeMap, HeatMap, ScatterChart, BoxplotChart</p>
          <p>✓ <strong style={{ color: 'var(--quafi-accent-primary)' }}>Flow:</strong> SankeyChart, FunnelChart, GraphChart</p>
          <p>✓ <strong style={{ color: 'var(--quafi-accent-primary)' }}>Time-based:</strong> CalendarChart, ThemeRiverChart</p>
          <p>✓ <strong style={{ color: 'var(--quafi-accent-primary)' }}>Multi-dimensional:</strong> ParallelChart</p>
          <p>✓ <strong style={{ color: 'var(--quafi-accent-primary)' }}>Hierarchical:</strong> TreeChart</p>
          <p>✓ <strong style={{ color: 'var(--quafi-accent-primary)' }}>Effect:</strong> EffectScatterChart</p>
          <p>✓ <strong style={{ color: 'var(--quafi-accent-primary)' }}>Pictorial:</strong> PictorialBarChart</p>
        </div>
      </ShowcaseSection>
    </div>
  );
