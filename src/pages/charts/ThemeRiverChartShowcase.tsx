...
// QUAFI Design System - Glass-Neumorphism ThemeRiver Chart
  ...
  return (
    <div style={{ background: 'var(--marble-base)', minHeight: '100%', padding: '24px' }}>
      <header style={showcase.header.container}>
        <h1 style={showcase.header.title}>&gt; ThemeRiverChart_</h1>
        <p style={showcase.header.description}>// Stream graph mostrando proporciones en el tiempo</p>
      </header>
