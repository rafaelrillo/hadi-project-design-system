...
// QUAFI Design System - Glass-Neumorphism Candlestick Chart
  ...
  return (
    <div style={{ background: 'var(--marble-base)', minHeight: '100%', padding: '24px' }}>
      <header style={{ ...showcase.header.container, boxShadow: 'var(--raised-3)' }}>
        <h1 style={showcase.header.title}>&gt; CandlestickChart_</h1>
        <p style={showcase.header.description}>// Grafico OHLC para visualizacion de datos financieros</p>
      </header>
