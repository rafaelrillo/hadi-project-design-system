...
// QUAFI Design System - Glass-Neumorphism Pie Chart
  ...
  return (
    <div style={{ background: 'var(--marble-base)', minHeight: '100%', padding: '24px' }}>
      <header style={showcase.header.container}>
        <h1 style={showcase.header.title}>&gt; PieChart_</h1>
        <p style={showcase.header.description}>// Graficos circulares para proporciones y distribuciones</p>
      </header>
