...
// QUAFI Design System - Glass-Neumorphism Sankey Chart
  ...
  return (
    <div style={{ background: 'var(--marble-base)', minHeight: '100%', padding: '24px' }}>
      <header style={showcase.header.container}>
        <h1 style={showcase.header.title}>&gt; SankeyChart_</h1>
        <p style={showcase.header.description}>// Diagrama de flujo de capital entre nodos</p>
      </header>
