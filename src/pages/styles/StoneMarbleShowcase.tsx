...
// QUAFI Design System - Stone Marble Neumorphism Reference
...
export function StoneMarbleShowcase() {
  ...
  const btnTealStyles: React.CSSProperties = {
    ...btnBaseStyles,
    background: 'linear-gradient(135deg, var(--quafi-accent-tertiary, #6fb3b5), var(--quafi-accent-primary, #3a6a72))',
    color: 'white',
  ...
  const toggleTrackStyles = (isActive: boolean): React.CSSProperties => ({
    ...
    height: '30px',
    background: isActive
      ? 'linear-gradient(135deg, var(--quafi-accent-tertiary, #6fb3b5), var(--quafi-accent-primary, #3a6a72))'
  ...
  return (
    <div style={showcaseStyles}>
      <header style={showcase.header.container}>
        <h1 style={showcase.header.title}>QUAFI Stone Marble</h1>
        ...
        <>
            ...
            <div style={grid(4)}>
              {[
                ...
                <div key={v.name} style={{ ...insetStyles(2), ...showcaseItemStyles }}>
                  <div style={{ ...lpStyles(v.intensity), fontFamily: 'var(--quafi-font-primary)', fontSize: v.size, fontWeight: 700 }}>
                    QUAFI
                  </div>
          ...
          <div style={sectionStyles}>
            ...
            <div style={grid(4)}>
              <div style={{ ...insetStyles(2), ...showcaseItemStyles }}>
                <div style={{ ...lpStyles('medium'), fontFamily: 'var(--quafi-font-mono)', fontSize: '24px', fontWeight: 700 }}>$191,856</div>
                <div style={demoLabelStyles}>Neutral</div>
              </div>
              <div style={{ ...insetStyles(2), ...showcaseItemStyles }}>
                <div style={{ ...lpColorStyles('teal'), fontFamily: 'var(--quafi-font-mono)', fontSize: '24px', fontWeight: 700 }}>$191,856</div>
                <div style={demoLabelStyles}>Teal</div>
              </div>
              <div style={{ ...insetStyles(2), ...showcaseItemStyles }}>
                <div style={{ ...lpColorStyles('positive'), fontFamily: 'var(--quafi-font-mono)', fontSize: '24px', fontWeight: 700 }}>+16.5%</div>
                <div style={demoLabelStyles}>Positive</div>
              </div>
              <div style={{ ...insetStyles(2), ...showcaseItemStyles }}>
                <div style={{ ...lpColorStyles('negative'), fontFamily: 'var(--quafi-font-mono)', fontSize: '24px', fontWeight: 700 }}>-8.2%</div>
          ...
          <div style={sectionStyles}>
            ...
            <div style={{ ...insetStyles(3), padding: '24px' }}>
              <div style={{ ...lpStyles('monumental'), fontFamily: 'var(--quafi-font-display)', fontSize: '48px', fontWeight: 700, letterSpacing: '-0.02em', marginBottom: '24px' }}>QUAFI</div>
              <div style={{ ...lpStyles('stamped'), fontFamily: 'var(--quafi-font-display)', fontSize: '36px', fontWeight: 700, marginBottom: '16px' }}>Portfolio Value</div>
              <div style={{ ...lpStyles('deep'), fontFamily: 'var(--quafi-font-mono)', fontSize: '56px', fontWeight: 700, marginBottom: '8px' }}>$1,234,567</div>
              <div style={{ ...lpColorStyles('positive'), fontFamily: 'var(--quafi-font-mono)', fontSize: '20px', fontWeight: 600, marginBottom: '24px' }}>+16.5% this month</div>
              <div style={{ ...lpStyles('medium'), fontFamily: 'var(--quafi-font-primary)', fontSize: '11px', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '12px' }}>Performance Metrics</div>
              <div style={{ ...lpStyles('soft'), fontFamily: 'var(--quafi-font-primary)', fontSize: '15px', lineHeight: 1.6 }}>
      ...
      {section === 'containers' && (
        <>
          ...
          <div style={sectionStyles}>
            ...
            <div style={{ ...insetStyles(3), padding: '24px' }}>
              <pre style={{ fontFamily: 'var(--quafi-font-mono)', fontSize: '12px', color: 'var(--quafi-text-secondary)', lineHeight: 1.8 }}>
{`FONDO (--marble-base)
        ...
        <>
            ...
            <div style={grid(2)}>
              ...
              <div style={{ maxWidth: '300px', margin: '0 auto', width: '100%' }}>
                <div style={{ width: '100%', height: '8px', background: 'var(--marble-base)', borderRadius: '100px', boxShadow: 'var(--inset-2)', position: 'relative' }}>
                  <div style={{ width: `${sliderValue}%`, height: '100%', background: 'linear-gradient(90deg, var(--quafi-accent-tertiary, #6fb3b5), var(--quafi-accent-primary, #3a6a72))', borderRadius: '100px' }} />
                ...
                <div style={{ textAlign: 'center', marginTop: '8px' }}>
                  <span style={{ ...lpStyles('strong'), fontFamily: 'var(--quafi-font-mono)', fontSize: '20px', fontWeight: 700 }}>{sliderValue}%</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={sectionStyles}>
            ...
            <div style={flex('center', 'center', 24)}>
              ...
              <div style={showcaseItemStyles}>
                <div style={{ width: '24px', height: '24px', background: 'var(--quafi-accent-primary)', borderRadius: '6px', boxShadow: 'var(--raised-1)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>
              ...
              <div style={showcaseItemStyles}>
                <div style={{ ...insetStyles(2), width: '24px', height: '24px', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', borderRadius: '50%' }}>
                  <div style={{ width: '10px', height: '10px', background: 'var(--quafi-accent-primary)', borderRadius: '50%', boxShadow: 'var(--raised-1)', opacity: 0 }} />
                </div>
                <div style={demoLabelStyles}>Unselected</div>
              </div>
              <div style={showcaseItemStyles}>
                <div style={{ ...insetStyles(2), width: '24px', height: '24px', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', borderRadius: '50%' }}>
                  <div style={{ width: '10px', height: '10px', background: 'var(--quafi-accent-primary)', borderRadius: '50%', boxShadow: 'var(--raised-1)' }} />
                </div>
            ...
            <div style={{ display: 'grid', gap: '20px' }}>
              <div>
                ...
                <div style={{ height: '12px', background: 'var(--marble-base)', borderRadius: '100px', boxShadow: 'var(--inset-2)', overflow: 'hidden' }}>
                  <div style={{ width: '25%', height: '100%', background: 'linear-gradient(90deg, var(--quafi-accent-tertiary, #6fb3b5), var(--quafi-accent-primary, #3a6a72))', borderRadius: '100px' }} />
                </div>
              </div>
              <div>
                <div style={{ ...lpStyles('subtle'), fontSize: '11px', marginBottom: '8px' }}>75% Complete</div>
                <div style={{ height: '12px', background: 'var(--marble-base)', borderRadius: '100px', boxShadow: 'var(--inset-2)', overflow: 'hidden' }}>
                  <div style={{ width: '75%', height: '100%', background: 'linear-gradient(90deg, var(--quafi-accent-tertiary, #6fb3b5), var(--quafi-accent-primary, #3a6a72))', borderRadius: '100px' }} />
                </div>
              </div>
            </div>
          </div>
        ...
        <>
          <div style={sectionStyles}>
            ...
            <div style={flex('center', 'center', 12)}>
              ...
              <span style={{ ...badgeBaseStyles, background: 'linear-gradient(135deg, var(--quafi-accent-tertiary), var(--quafi-accent-primary))', color: 'white', borderRadius: '100px' }}>Teal</span>
          ...
          <div style={sectionStyles}>
            ...
            <div style={flex('center', 'center', 8)}>
              {['$AAPL', '$MSFT', '$GOOGL', '$NVDA', '$TSLA'].map(ticker => (
                <span key={ticker} style={{ display: 'inline-block', padding: '4px 12px', fontFamily: 'var(--quafi-font-mono)', fontSize: '10px', fontWeight: 600, background: 'var(--marble-base)', borderRadius: '6px', boxShadow: 'var(--inset-1)', ...lpColorStyles('teal') }}>{ticker}</span>
              ))}
            </div>
          </div>
          ...
          <div style={sectionStyles}>
            ...
            <div style={flex('center', 'center', 16)}>
              <div style={showcaseItemStyles}>
                <div style={{ ...raisedStyles(2), width: '48px', height: '48px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--quafi-font-primary)', fontWeight: 600, fontSize: '18px', ...lpStyles('medium') }}>JD</div>
                <div style={demoLabelStyles}>Raised</div>
              </div>
              <div style={showcaseItemStyles}>
                <div style={{ ...insetStyles(2), width: '48px', height: '48px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--quafi-font-primary)', fontWeight: 600, fontSize: '18px', ...lpStyles('soft') }}>AB</div>
                <div style={demoLabelStyles}>Inset</div>
              </div>
              <div style={showcaseItemStyles}>
                <div style={{ ...raisedStyles(2), width: '48px', height: '48px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--quafi-font-primary)', fontWeight: 600, fontSize: '18px', ...lpStyles('medium') }}>MK</div>
                <div style={demoLabelStyles}>Square</div>
              </div>
            </div>
          </div>
          ...
          <div style={sectionStyles}>
            ...
            <div style={flex('center', 'center', 24)}>
              <div style={showcaseItemStyles}>
                <div style={meterStyles}>
                  <div style={meterInnerStyles}>
                    <div style={{ ...lpStyles('deep'), fontFamily: 'var(--quafi-font-mono)', fontSize: '24px', fontWeight: 700 }}>87</div>
              ...
              <div style={showcaseItemStyles}>
                <div style={meterStyles}>
                  <div style={meterInnerStyles}>
                    <div style={{ ...lpColorStyles('warning'), fontFamily: 'var(--quafi-font-mono)', fontSize: '24px', fontWeight: 700 }}>42</div>
              ...
              <div style={showcaseItemStyles}>
                <div style={meterStyles}>
                  <div style={meterInnerStyles}>
                    <div style={{ ...lpColorStyles('positive'), fontFamily: 'var(--quafi-font-mono)', fontSize: '24px', fontWeight: 700 }}>+16%</div>
            ...
            <div style={flex('center', 'center', 32)}>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{ transform: 'rotate(-45deg)', textAlign: 'center' }}>
                      <div style={{ ...lpStyles('deep'), fontFamily: 'var(--quafi-font-mono)', fontSize: '22px', fontWeight: 700 }}>78</div>
              ...
              <div style={showcaseItemStyles}>
                <div style={{
                  ...
                  borderRadius: '12px',
                  boxShadow: 'var(--raised-3)',
                  border: '3px solid var(--quafi-accent-primary)',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                }}>
                  <div style={{
                    ...
                    <div style={{ transform: 'rotate(-45deg)', textAlign: 'center' }}>
                      <div style={{ ...lpColorStyles('teal'), fontFamily: 'var(--quafi-font-mono)', fontSize: '18px', fontWeight: 700 }}>$12K</div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      width: '50px',
                      height: '50px',
                      background: 'linear-gradient(135deg, var(--quafi-accent-tertiary), var(--quafi-accent-primary))',
                      borderRadius: '6px',
                      boxShadow: 'var(--raised-2)',
                      display: 'flex',
                      alignItems: 'center',
                      ...
                      <div style={{ transform: 'rotate(-45deg)', textAlign: 'center' }}>
                        <div style={{ color: 'white', fontFamily: 'var(--quafi-font-mono)', fontSize: '16px', fontWeight: 700, textShadow: '0 1px 2px rgba(0,0,0,0.2)' }}>★</div>
              ...
              <div style={showcaseItemStyles}>
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{ transform: 'rotate(-45deg)', textAlign: 'center' }}>
                      <div style={{ ...lpColorStyles('negative'), fontFamily: 'var(--quafi-font-mono)', fontSize: '18px', fontWeight: 700 }}>-3.2%</div>
            ...
            <div style={flex('center', 'center', 32)}>
              ...
              <div style={showcaseItemStyles}>
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{ ...lpColorStyles('teal'), fontFamily: 'var(--quafi-font-mono)', fontSize: '20px', fontWeight: 700 }}>A</div>
              ...
              <div style={showcaseItemStyles}>
                <div style={{
                  width: '80px',
                  height: '96px',
                  background: 'linear-gradient(180deg, var(--quafi-accent-primary), var(--quafi-accent-tertiary))',
                  clipPath: 'polygon(50% 0%, 100% 15%, 100% 65%, 50% 100%, 0% 65%, 0% 15%)',
                  filter: 'drop-shadow(4px 4px 8px var(--shadow-dark)) drop-shadow(-4px -4px 8px var(--shadow-light))',
                  display: 'flex',
                  alignItems: 'center',
              ...
              <div style={showcaseItemStyles}>
                <div style={{
                  ...
                  <div style={{ ...lpColorStyles('warning'), fontFamily: 'var(--quafi-font-mono)', fontSize: '14px', fontWeight: 700 }}>MED</div>
            ...
            <div style={{ display: 'grid', gap: '20px' }}>
              ...
              <div style={flex('center', 'center', 16)}>
                ...
                <div style={{
                  ...
                  <div>
                    <div style={{ ...lpStyles('strong'), fontFamily: 'var(--quafi-font-mono)', fontSize: '16px', fontWeight: 700 }}>$247</div>
                ...
                <div style={{
                  ...
                  <div style={{ ...lpColorStyles('teal'), fontFamily: 'var(--quafi-font-mono)', fontSize: '18px', fontWeight: 700 }}>12</div>
                ...
                <div style={{
                  width: '150px',
                  height: '50px',
                  background: 'linear-gradient(90deg, var(--quafi-accent-tertiary), var(--quafi-accent-primary))',
                  borderRadius: '25px',
                  ...
                  <div>
                    <div style={{ color: 'white', fontFamily: 'var(--quafi-font-mono)', fontSize: '16px', fontWeight: 700, textShadow: '0 1px 2px rgba(0,0,0,0.2)' }}>94.2%</div>
              ...
              <div style={flex('center', 'center', 20)}>
                ...
                <div style={{
                  ...
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ ...lpColorStyles('positive'), fontFamily: 'var(--quafi-font-mono)', fontSize: '16px', fontWeight: 700 }}>+18</div>
                    <div style={{ ...lpStyles('whisper'), fontSize: '8px' }}>WINS</div>
                  </div>
                  <div style={{ width: '1px', height: '30px', background: 'var(--marble-dark)' }} />
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ ...lpColorStyles('negative'), fontFamily: 'var(--quafi-font-mono)', fontSize: '16px', fontWeight: 700 }}>-4</div>
                    <div style={{ ...lpStyles('whisper'), fontSize: '8px' }}>LOSSES</div>
                  </div>
                  <div style={{ width: '1px', height: '30px', background: 'var(--marble-dark)' }} />
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ ...lpColorStyles('teal'), fontFamily: 'var(--quafi-font-mono)', fontSize: '16px', fontWeight: 700 }}>82%</div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{ ...lpStyles('stamped'), fontFamily: 'var(--quafi-font-mono)', fontSize: '20px', fontWeight: 700 }}>$1.2M</div>
                    <div style={{ ...lpStyles('stamped'), color: 'var(--quafi-status-positive)', fontFamily: 'var(--quafi-font-mono)', fontSize: '12px', fontWeight: 600 }}>↑ 12%</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div style={sectionStyles}>
            ...
            <div style={grid(3, 20)}>
              ...
              <div style={{
                ...
                <div style={{ ...lpStyles('monumental'), fontFamily: 'var(--quafi-font-mono)', fontSize: '32px', fontWeight: 700 }}>$2.4M</div>
                <div style={{ display: 'flex', justifyContent: 'center', gap: '6px', marginTop: '8px' }}>
                  <span style={{ ...lpColorStyles('positive'), fontFamily: 'var(--quafi-font-mono)', fontSize: '12px' }}>↑ 8.2%</span>
              ...
              <div style={{
                ...
                <div style={{ ...lpColorStyles('teal'), fontFamily: 'var(--quafi-font-mono)', fontSize: '28px', fontWeight: 700 }}>156</div>
              ...
              <div style={{
                ...
                {/* Corner accents */}
                <div style={{ position: 'absolute', top: '0', left: '0', width: '20px', height: '20px', borderTopLeftRadius: '16px', borderTop: '3px solid var(--quafi-accent-primary)', borderLeft: '3px solid var(--quafi-accent-primary)' }} />
                <div style={{ position: 'absolute', top: '0', right: '0', width: '20px', height: '20px', borderTopRightRadius: '16px', borderTop: '3px solid var(--quafi-accent-primary)', borderRight: '3px solid var(--quafi-accent-primary)' }} />
                <div style={{ position: 'absolute', bottom: '0', left: '0', width: '20px', height: '20px', borderBottomLeftRadius: '16px', borderBottom: '3px solid var(--quafi-accent-primary)', borderLeft: '3px solid var(--quafi-accent-primary)' }} />
                <div style={{ position: 'absolute', bottom: '0', right: '0', width: '20px', height: '20px', borderBottomRightRadius: '16px', borderBottom: '3px solid var(--quafi-accent-primary)', borderRight: '3px solid var(--quafi-accent-primary)' }} />

                <div style={{ ...lpStyles('whisper'), fontSize: '9px', letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: '8px' }}>SHARPE RATIO</div>
                <div style={{ ...lpStyles('stamped'), fontFamily: 'var(--quafi-font-mono)', fontSize: '36px', fontWeight: 700 }}>1.84</div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <div style={{ ...lpStyles('stamped'), fontFamily: 'var(--quafi-font-mono)', fontSize: '22px', fontWeight: 700 }}>98</div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <div style={{ ...lpColorStyles('teal'), fontFamily: 'var(--quafi-font-mono)', fontSize: '18px', fontWeight: 700 }}>TOP</div>
                      <div style={{ ...lpStyles('deep'), fontFamily: 'var(--quafi-font-mono)', fontSize: '24px', fontWeight: 700 }}>5%</div>
                    </div>
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <div style={{ color: '#5a4800', fontFamily: 'var(--quafi-font-mono)', fontSize: '10px', fontWeight: 700, letterSpacing: '0.05em' }}>GOLD</div>
                    </div>
                  </div>
                </div>
          ...
          <div style={sectionStyles}>
            ...
            <div style={grid(4, 16)}>
              <div style={statCardStyles}>
                ...
                <div style={{ ...lpStyles('deep'), fontFamily: 'var(--quafi-font-mono)', fontSize: '28px', fontWeight: 700 }}>$191K</div>
              ...
              <div style={statCardStyles}>
                <div style={statIconStyles}>📈</div>
                <div style={{ ...lpColorStyles('positive'), fontFamily: 'var(--quafi-font-mono)', fontSize: '28px', fontWeight: 700 }}>+16.5%</div>
              ...
              <div style={statCardStyles}>
                ...
                <div style={{ ...lpColorStyles('warning'), fontFamily: 'var(--quafi-font-mono)', fontSize: '28px', fontWeight: 700 }}>42</div>
              ...
              <div style={statCardStyles}>
                <div style={statIconStyles}>🎯</div>
                <div style={{ ...lpColorStyles('teal'), fontFamily: 'var(--quafi-font-mono)', fontSize: '28px', fontWeight: 700 }}>87%</div>
            ...
            <div style={grid(2, 20)}>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ ...lpStyles('deep'), fontFamily: 'var(--quafi-font-mono)', fontSize: '20px', fontWeight: 700 }}>$247K</div>
                    <div style={{ ...lpStyles('whisper'), fontSize: '9px', letterSpacing: '0.08em' }}>TOTAL VALUE</div>
                  </div>
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ ...lpColorStyles('positive'), fontFamily: 'var(--quafi-font-mono)', fontSize: '20px', fontWeight: 700 }}>+12.4%</div>
                    <div style={{ ...lpStyles('whisper'), fontSize: '9px', letterSpacing: '0.08em' }}>YTD RETURN</div>
                  </div>
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ ...lpColorStyles('teal'), fontFamily: 'var(--quafi-font-mono)', fontSize: '20px', fontWeight: 700 }}>24</div>
                    <div style={{ ...lpStyles('whisper'), fontSize: '9px', letterSpacing: '0.08em' }}>HOLDINGS</div>
                  </div>
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ ...lpColorStyles('warning'), fontFamily: 'var(--quafi-font-mono)', fontSize: '20px', fontWeight: 700 }}>38</div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{
                      ...
                      <div>
                        <div style={{ ...lpColorStyles('positive'), fontFamily: 'var(--quafi-font-mono)', fontSize: '14px', fontWeight: 700 }}>100%</div>
                        <div style={{ ...lpStyles('whisper'), fontSize: '8px' }}>ENCRYPTED</div>
                      </div>
                      <div>
                        <div style={{ ...lpColorStyles('teal'), fontFamily: 'var(--quafi-font-mono)', fontSize: '14px', fontWeight: 700 }}>2FA</div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-around' }}>
                  ...
                  <div style={{ textAlign: 'center' }}>
                    <div style={{
                      ...
                      <div style={{
                        ...
                        <div style={{ ...lpStyles('deep'), fontFamily: 'var(--quafi-font-mono)', fontSize: '16px', fontWeight: 700 }}>+12%</div>
                      </div>
                    </div>
                  ...
                  <div style={{ textAlign: 'center' }}>
                    <div style={{
                      ...
                      <div style={{ transform: 'rotate(-45deg)', textAlign: 'center' }}>
                        <div style={{ color: 'white', fontFamily: 'var(--quafi-font-mono)', fontSize: '16px', fontWeight: 700, textShadow: '0 1px 2px rgba(0,0,0,0.2)' }}>+6%</div>
            ...
            <div>
              {[
                ...
                <div key={i} style={tableRowStyles}>
                  <span style={{ ...lpColorStyles('teal'), fontFamily: 'var(--quafi-font-mono)', fontSize: '11px', fontWeight: 600 }}>{s.rank}</span>
                  <span style={{ ...lpStyles('strong'), fontFamily: 'var(--quafi-font-mono)', fontSize: '14px', fontWeight: 600 }}>{s.sym}</span>
                  <span style={{ ...lpStyles('subtle'), fontSize: '12px' }}>{s.name}</span>
                  <span style={{ ...lpStyles('medium'), fontFamily: 'var(--quafi-font-mono)', fontSize: '14px', fontWeight: 500 }}>{s.price}</span>
                  <span style={{ ...(s.pos ? lpColorStyles('positive') : lpColorStyles('negative')), fontFamily: 'var(--quafi-font-mono)', fontSize: '13px', fontWeight: 500 }}>{s.change}</span>
                </div>
              ))}
            </div>
          </div>
              ...
              <div style={{ ...insetStyles(2), padding: '16px' }}>
                {['META', 'AVGO', 'CRM'].map((sym, i) => (
                  <div key={sym} style={{ ...glassStyles, display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 16px', marginTop: i > 0 ? '8px' : 0 }}>
                    <span style={{ ...lpStyles('medium'), fontFamily: 'var(--quafi-font-mono)', fontSize: '13px', fontWeight: 600 }}>{sym}</span>
                    <span style={{ ...lpColorStyles('positive'), fontFamily: 'var(--quafi-font-mono)', fontSize: '12px', fontWeight: 500 }}>+{(Math.random() * 3).toFixed(2)}%</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <>
          ...
          <div style={sectionStyles}>
            ...
            <div style={grid(2, 20)}>
              ...
              <div style={{
                ...
                <div style={{ ...lpStyles('stamped'), fontFamily: 'var(--quafi-font-mono)', fontSize: '32px', fontWeight: 700 }}>$191,856</div>
                <div style={{ ...lpColorStyles('positive'), fontFamily: 'var(--quafi-font-mono)', fontSize: '13px', marginTop: '4px' }}>+16.5%</div>
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ textAlign: 'center' }}>
                    ...
                    <div style={{ ...lpColorStyles('warning'), fontFamily: 'var(--quafi-font-mono)', fontSize: '20px', fontWeight: 700 }}>42</div>
                  </div>
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ ...lpStyles('whisper'), fontSize: '9px', letterSpacing: '0.1em', textTransform: 'uppercase' }}>SCORE</div>
                    <div style={{ ...lpColorStyles('teal'), fontFamily: 'var(--quafi-font-mono)', fontSize: '20px', fontWeight: 700 }}>87</div>
                  </div>
                </div>
              </div>
              ...
              <div style={showcaseItemStyles}>
                <div style={emblemStyles}>
                  <div style={emblemInnerStyles}>
                    <span style={{ ...lpStyles('stamped'), fontFamily: 'var(--quafi-font-display)', fontSize: '32px', fontWeight: 700 }}>S</span>
                  </div>
                </div>
              ...
              <div style={showcaseItemStyles}>
                <div style={{
                  ...
                  <div style={{
                    ...
                    <span style={{ ...lpColorStyles('teal'), fontFamily: 'var(--quafi-font-mono)', fontSize: '18px', fontWeight: 700 }}>PRO</span>
                  </div>
                </div>
          ...
          <div style={sectionStyles}>
            ...
            <div style={grid(3, 20)}>
              ...
              <div style={{
                ...
                {/* Teal accent corners */}
                <div style={{ position: 'absolute', top: '0', left: '0', width: '24px', height: '24px', borderTopLeftRadius: '16px', borderTop: '3px solid var(--quafi-accent-primary)', borderLeft: '3px solid var(--quafi-accent-primary)' }} />
                <div style={{ position: 'absolute', top: '0', right: '0', width: '24px', height: '24px', borderTopRightRadius: '16px', borderTop: '3px solid var(--quafi-accent-primary)', borderRight: '3px solid var(--quafi-accent-primary)' }} />
                <div style={{ position: 'absolute', bottom: '0', left: '0', width: '24px', height: '24px', borderBottomLeftRadius: '16px', borderBottom: '3px solid var(--quafi-accent-primary)', borderLeft: '3px solid var(--quafi-accent-primary)' }} />
                <div style={{ position: 'absolute', bottom: '0', right: '0', width: '24px', height: '24px', borderBottomRightRadius: '16px', borderBottom: '3px solid var(--quafi-accent-primary)', borderRight: '3px solid var(--quafi-accent-primary)' }} />
          ...
          <div style={sectionStyles}>
            ...
            <div style={{ display: 'grid', gap: '32px', padding: '20px 0' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
                {[4, 6, 8, 10, 12, 10, 8, 6, 4].map((size, i) => (
                  <div key={i} style={{
                    width: `${size}px`,
                    height: `${size}px`,
                    background: i === 4 ? 'var(--quafi-accent-primary)' : 'var(--marble-base)',
                    borderRadius: '50%',
                    boxShadow: i === 4 ? 'var(--raised-2)' : 'var(--raised-1)',
                  }} />
                ))}
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <div style={{ flex: 1, height: '2px', background: 'linear-gradient(90deg, transparent, var(--quafi-accent-primary))', borderRadius: '1px' }} />
                <div style={{ width: '40px', height: '4px', background: 'linear-gradient(90deg, var(--quafi-accent-tertiary), var(--quafi-accent-primary))', borderRadius: '2px', boxShadow: '0 2px 4px rgba(58, 106, 114, 0.3)' }} />
                <div style={{ flex: 1, height: '2px', background: 'linear-gradient(90deg, var(--quafi-accent-primary), transparent)', borderRadius: '1px' }} />
              </div>
            </div>
          </div>
                ...
                <div style={{ display: 'flex', gap: '6px' }}>
                  {[1, 2, 3, 4, 5].map(i => (
                    <div key={i} style={{
                      width: '10px',
                      height: '10px',
                      background: i <= 3 ? 'var(--quafi-accent-primary)' : 'var(--marble-base)',
                      borderRadius: '50%',
                  ...
                  {[1, 2, 3, 4].map(i => (
                    <React.Fragment key={i}>
                      <div style={{
                        width: '24px',
                        height: '24px',
                        background: i <= 2 ? 'var(--quafi-accent-primary)' : 'var(--marble-base)',
                        borderRadius: '50%',
                      ...
                      {i < 4 && <div style={{ width: '20px', height: '2px', background: i < 2 ? 'var(--quafi-accent-primary)' : 'var(--marble-base)', boxShadow: i < 2 ? 'none' : 'var(--inset-1)', borderRadius: '1px' }} />}
                    </React.Fragment>
                  ))}
                </div>
          ...
          <div style={sectionStyles}>
            ...
            <div style={{ ...raisedStyles(4), padding: '32px', textAlign: 'center' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', marginBottom: '20px' }}>
                ...
                <div style={{ width: '70px', height: '70px', background: 'var(--marble-base)', borderRadius: '50%', boxShadow: 'var(--raised-3)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <div style={{ width: '50px', height: '50px', background: 'var(--marble-base)', borderRadius: '50%', boxShadow: 'var(--inset-2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <span style={{ ...lpStyles('stamped'), fontFamily: 'var(--quafi-font-display)', fontSize: '24px', fontWeight: 700 }}>S</span>
                  </div>
                </div>
                <div style={{ width: '6px', height: '6px', background: 'var(--marble-base)', borderRadius: '50%', boxShadow: 'var(--inset-1)' }} />
                <div style={{ width: '40px', height: '2px', background: 'var(--marble-base)', boxShadow: 'var(--raised-1)', borderRadius: '1px' }} />
              ...
              {/* Title */}
              <div style={{ ...lpStyles('monumental'), fontFamily: 'var(--quafi-font-display)', fontSize: '36px', fontWeight: 700, letterSpacing: '-0.02em' }}>QUAFI</div>
            ...
            <div style={grid(2, 24)}>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                  ...
                  >
                    <span style={{ fontSize: '14px', color: 'var(--quafi-accent-primary)', filter: 'drop-shadow(-0.5px -0.5px 0px rgba(255, 255, 255, 0.9)) drop-shadow(0.5px 0.5px 0px rgba(130, 140, 155, 0.4))' }}>📈</span>
                  </span>
...
.iconRaised {
  color: var(--quafi-accent-primary);  /* o var(--marble-dark) para neutral */
  filter:
          ...
          <div style={sectionStyles}>
            ...
            <div style={{ ...insetStyles(2), padding: '20px' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '80px 80px 100px 1fr', gap: '16px', alignItems: 'center' }}>
                ...
                <div style={{ ...lpStyles('medium'), fontFamily: 'var(--quafi-font-mono)', fontSize: '12px' }}>24px</div>
                <div style={{ ...lpStyles('medium'), fontFamily: 'var(--quafi-font-mono)', fontSize: '12px' }}>12-13px</div>
                ...
                <div style={{ ...lpStyles('medium'), fontFamily: 'var(--quafi-font-mono)', fontSize: '12px' }}>28px</div>
                <div style={{ ...lpStyles('medium'), fontFamily: 'var(--quafi-font-mono)', fontSize: '12px' }}>14-15px</div>
                ...
                <div style={{ ...lpStyles('medium'), fontFamily: 'var(--quafi-font-mono)', fontSize: '12px' }}>36px</div>
                <div style={{ ...lpStyles('medium'), fontFamily: 'var(--quafi-font-mono)', fontSize: '12px' }}>18-20px</div>
