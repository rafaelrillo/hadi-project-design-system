// Path: src/components/atoms/QuafiEmblem/QuafiEmblem.tsx
// QUAFI Emblem - Radar/Pulse Symbol with Stone Marble Inset Container
import React from "react";
import styles from "./QuafiEmblem.module.css";

// ═══════════════════════════════════════════════════════════════════════════════
// TYPES
// ═══════════════════════════════════════════════════════════════════════════════

export type QuafiEmblemAnimation =
  | "none"
  | "breathe"
  | "pulse"
  | "glow"
...
export type QuafiEmblemVariant = "simple" | "framed";

export interface QuafiEmblemProps {
  /** Size of the emblem container in pixels */
  size?: number;
  /** Animation type */
  animation?: QuafiEmblemAnimation;
  ...
  return (
    ...
    >
      ...
      <circle
        ...
        cy="50"
        r="5"
        fill="var(--quafi-symbol-fill, #babec4)"
        filter="url(#quafi-carve-subtle)"
      ...
      <circle
        ...
        r="15"
        fill="none"
        stroke="var(--quafi-symbol-stroke, #b2b6bc)"
        strokeWidth="2"
        filter="url(#quafi-carve-subtle)"
...
export const QuafiEmblem: React.FC<QuafiEmblemProps> = ({
  size = 100,
  animation = "none",
  className = "",
  showWordmark = false,
...
export interface QuafiLockupProps {
...
export const QuafiLockupHorizontal: React.FC<QuafiLockupProps> = ({
  size = 70,
  animation = "none",
  className = "",
}) => {
...
export const QuafiLockupVertical: React.FC<QuafiLockupProps> = ({
  size = 80,
  animation = "none",
  className = "",
}) => {
