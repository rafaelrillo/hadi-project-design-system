// Path: src/components/organisms/fing/PerformanceChart/PerformanceChart.tsx
...
/* ═══════════════════════════════════════════════════════════════════════════════
   ...
   Historical performance visualization with FING aesthetic
   ═══════════════════════════════════════════════════════════════════════════════ */
...
const DEFAULT_COLORS = [
  ...
  'var(--fing-status-positive)',
  'var(--fing-status-warning)',
  'var(--fing-status-negative)',
  '#9f7aea',
  '#ed8936',
];
