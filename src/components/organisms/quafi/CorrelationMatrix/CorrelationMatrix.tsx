// Path: src/components/organisms/quafi/CorrelationMatrix/CorrelationMatrix.tsx
        ...
        <div className={styles.legend}>
          <div className={styles.legendItem}>
            <span
              ...
              style={{ background: 'var(--quafi-status-negative)' }}
            />
            <span>-1.0</span>
          </div>
          ...
          <div className={styles.legendItem}>
            <span
              className={styles.legendColor}
              style={{ background: 'var(--quafi-status-positive)' }}
            />
            <span>+1.0</span>
          </div>
        </div>
