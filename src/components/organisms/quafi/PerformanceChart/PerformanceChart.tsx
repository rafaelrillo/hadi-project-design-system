// Path: src/components/organisms/quafi/PerformanceChart/PerformanceChart.tsx
...
/* ═══════════════════════════════════════════════════════════════════════════════
   ...
   Historical performance visualization with QUAFI aesthetic
   ═══════════════════════════════════════════════════════════════════════════════ */
...
const DEFAULT_COLORS = [
  ...
  'var(--quafi-status-positive)',
  'var(--quafi-status-warning)',
  'var(--quafi-status-negative)',
  '#9f7aea',
  '#ed8936',
];
